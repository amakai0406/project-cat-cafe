...
<section class="pb-24">
    <div class="container px-4 mx-auto">
        ...
        <div class="container px-4 mx-auto flex flex-wrap -mx-3">
                ...
                <article class="w-full md:w-1/2 lg:w-1/3 p-3">
                    <div class="border rounded-lg overflow-hidden shadow">
                        <div class="relative h-52">
                            ...
                            <a href="#"><img class="w-full h-56 object-cover" src="{{ asset('storage/' . $blog->image) }}"
                                    alt=""></a>
    ...
    <div class="mt-10">
        <div class="flex justify-center items-center">
            ...
            <a class="flex items-center justify-center h-10 w-10 mr-3 text-xl font-semibold text-white rounded-xl bg-gray-600"
                href="#">1</a>
            <a class="flex items-center justify-center h-10 w-10 mr-3 text-xl font-semibold text-gray-400 rounded-xl hover:bg-gray-50"
                href="#">2</a>
            <a class="flex items-center justify-center h-10 w-10 mr-3 text-xl font-semibold text-gray-400 rounded-xl hover:bg-gray-50"
                href="#">3</a>
            <a class="flex items-center justify-center h-10 w-10 mr-3 text-xl font-semibold text-gray-400 rounded-xl hover:bg-gray-50"
