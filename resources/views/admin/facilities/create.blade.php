        ...
        <div class="py-4 bg-white rounded">
            <form action="{{ route('admin.facilities.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="flex px-6 pb-4 border-b">
                    <h3 class="text-xl font-bold">設備の追加</h3>
                    <div class="ml-auto">
                        <button type="submit"
                ...
                <div class="pt-4 px-6">
                    ...
                    <div class="mb-6">
                        <label class="block text-sm font-medium mb-2" for="description">説明文</label>
                        <input id="description" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded"
                            type="text" name="description" value="{{ old('description') }}">
                    </div>

                    <div class="mb-6">
                        <label class="block text-sm font-medium mb-2" for="installed_at">導入日</label>
                        <input id="installed_at" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded"
                            type="date" name="installed_at" value="{{ $facility->installed_at }}">
                    </div>
