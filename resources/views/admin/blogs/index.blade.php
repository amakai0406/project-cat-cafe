...
<section>
    <div class="mb-6 py-4 bg-white rounded">
        <div class="flex px-6 pb-4 border-b">
            <h2 class="text-xl font-bold">ブログ一asjdcnksdjnckjsdncksjdckjsdc覧</h2>
            <div class="ml-auto">
                <a href="/admin/blogs/create"
                    class="py-2 px-3 text-xs text-white font-semibold bg-indigo-500 rounded-md">新aisdcbasjdcksdcsakdjnc規投稿</a>
            </div>
        </div>
